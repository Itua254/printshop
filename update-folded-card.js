...
async function updateFoldedCard() {
    const imgName = 'folded-card-obituary.jpg';
    const imgPath = './public/images/folded-card-obituary.jpg';
    ...
    console.log(`🚀 Uploading Folded Card design: ${imgName}...`);
    ...
    const updatedVariants = product.variants.map(v => {
        if (v.type === 'folded' || v.label === 'Folded Cards') {
            console.log(`🎯 Updating Folded Cards variant image...`);
    ...
    if (updateError) {
        ...
        console.log('✅ Success! Folded Cards updated with obituary template.');
    }
}
